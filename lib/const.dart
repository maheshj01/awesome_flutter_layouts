...
// Used for CustomListview
 ...
 List<List<Color>> colors = <List<Color>>[
  ...
  List layout_list = [CustomListView(),MyApp(),UserProfile(),AwesomeEndDrawer(),];

  // add a title to your layout as an identity this will appear in the list View in main.dart

  List layout_title= ["CustomListView","empty_page","User Profile Page","Awesome end Drawer",];
...
// Used for AwesomeDrawer
  ...
  List imageurl=["https://everipedia-storage.s3-accelerate.amazonaws.com/ProfilePics/6969909036-1492880896.jpeg",
